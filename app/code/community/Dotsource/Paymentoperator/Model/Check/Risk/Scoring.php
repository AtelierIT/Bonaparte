 ...
 * mbloss - refactoring for multiple risk check types
 */

/**
 * Risk model for Scoring API
 */
class Dotsource_Paymentoperator_Model_Check_Risk_Scoring
    extends Dotsource_Paymentoperator_Model_Check_Risk_Abstract
{
     ...
     *
     * @param $payment
     * @return Dotsource_Paymentoperator_Model_Check_Risk_Scoring
     */
